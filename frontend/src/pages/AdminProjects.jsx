...
const AdminProjects = () => {
  ...
  const applyFilters = () => {
    ...
    if (managerFilter !== 'all') {
      filtered = filtered.filter(project => project.managerId === parseInt(managerFilter));
    }
      ...
      <main className="content">
        <div className="content-wrapper">
          ...
          <div className="page-header-admin">
            <div className="page-header-content">
              ...
              <p className="page-subtitle">
                Supervision et gestion complète des projets de la plateforme
              </p>
            </div>
          </div>
          ...
          <div className="quick-stats-admin">
            ...
            <div className="quick-stat-item">
              <div className="quick-stat-icon amber">⏸️</div>
              <div className="quick-stat-content">
            ...
            <div className="quick-stat-item">
              ...
              <div className="quick-stat-content">
                <div className="quick-stat-value">{projectStats.totalBudget.toLocaleString('fr-FR')}</div>
                <div className="quick-stat-label">Budget total</div>
              </div>
            </div>
          </div>
                ...
                {filteredProjects.map(project => {
                  ...
                  return (
                    <div key={project.id} className="project-card-admin">
                      <div 
                        className="project-color-bar-admin" 
                      ...
                      <div className="project-card-content">
                        <div className="project-header-admin">
                          ...
                          <div className="project-badges-admin">
                            <span className={`badge-admin ${statusInfo.class}`}>
                              <span className="badge-icon">{statusInfo.icon}</span>
                              {statusInfo.label}
                            </span>
                            <span className={`badge-admin ${priorityInfo.class}`}>
                        ...
                        <div className="project-actions-admin">
                          <button 
                            className="btn-action-admin view"
                          ...
                          <button 
                            className="btn-action-admin edit"
        ...
        {/* Bouton Floating pour créer un projet */}
<button 
  className="fab-create-project"
